...
(function($) {
	...
	slimScroll : function(options) {
		...
		// check if we should hide the scrollbar when user is hovering
		// over
		...
		// whether we should use jQuery UI Draggable to enable bar
		// dragging
		railDraggable : true,
		...
		if (me.parent().hasClass(o.wrapperClass)) {
			...
			// Pass height: auto to an existing slimscroll object to
			// force a resize after contents have changed
		...
		function scrollContent(y, isWheel, isJump) {
			...
			// if scrolling down, make sure a fractional change to
			// the
			// scroll position isn't rounded away when the
			// scrollbar's CSS is set
			// this flooring of delta would happened automatically
			// when
		...
		function getBarHeight() {
		    // calculate scrollbar height and make sure it is not too
		    // small
